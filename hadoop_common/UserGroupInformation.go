...
func CreateCurrentUserInfoProto() (*UserInformationProto, error) {
  ...
  return &UserInformationProto{EffectiveUser: nil, RealUser: &username}, nil
}


func Allocate(userInfo *UserInformationProto, userTokens []TokenProto) (*UserGroupInformation) {
  ...
  if(userTokens != nil) {
    ...
    ugi.userTokens = make([]TokenProto, 0, maxTokens);  //empty, with room for maxTokens tokens.
  }
...
func (ugi *UserGroupInformation) GetUserInformation () (*UserInformationProto) {
  return ugi.userInfo
}

func (ugi *UserGroupInformation) GetUserTokens () ([]TokenProto) {
  return ugi.userTokens
}

func (ugi* UserGroupInformation) AddUserToken(token *TokenProto) {
